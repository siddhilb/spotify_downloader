...
# --- Functions (Ensure these are defined) ---
download_dir = 'temp_downloads'
# ... (delete_contents function here) ...
...
def download_music():
    ...
    # Initialize log
    spotdl_log = "SpotDL command executed.\n"
    ...
    try:
        ...
        result = subprocess.run(
            ...
            capture_output=True,
            text=True,
            check=False # Set to False so we capture the log even on non-zero exit code
        )
    ...
    return files, spotdl_log # Return both the files and the log
